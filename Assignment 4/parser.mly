...
expr:
  ...
  | CRTIV LPAREN expr RPAREN { IcrtVectorLit($3) }
  | CRTFV LPAREN expr RPAREN { FcrtVectorLit($3) }
  | CRTIM LPAREN expr COMMA expr RPAREN { IcrtMatrixLit($3, $5) }
  | CRTFM LPAREN expr COMMA expr RPAREN { FcrtMatrixLit($3, $5) }
