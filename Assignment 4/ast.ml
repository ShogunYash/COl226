...
type expr =
  ...
  | IcrtVectorLit of expr                   (** Integer vector creation *)
  | FcrtVectorLit of expr                   (** Float vector creation *)
  | IcrtMatrixLit of expr * expr            (** Integer matrix creation *)
  | FcrtMatrixLit of expr * expr            (** Float matrix creation *)
...
let rec string_of_expr expr =
  ...
  | IcrtVectorLit expr -> "IcrtVectorLit (" ^ string_of_expr expr ^ ")"
  | FcrtVectorLit expr -> "FcrtVectorLit (" ^ string_of_expr expr ^ ")"
  | IcrtMatrixLit (rows, cols) -> "IcrtMatrixLit (" ^ string_of_expr rows ^ ", " ^ string_of_expr cols ^ ")"
  | FcrtMatrixLit (rows, cols) -> "FcrtMatrixLit (" ^ string_of_expr rows ^ ", " ^ string_of_expr cols ^ ")"
